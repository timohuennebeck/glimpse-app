...
export const demoThreads: Array<ThreadRow & { photo?: number }> = [
  ...
  },
  {
    partner_id: 'alex',
    last_message_id: 'm4',
    last_body: 'The light yesterday was unreal',
  ...
  },
  {
    partner_id: 'noah',
    last_message_id: 'm5',
    last_body: 'Sending you something in a sec',
    last_moment_id: null,
    last_sender_id: 'noah',
    last_at: daysAgo(3),
    unread_count: 0,
...
export const demoMessages: Array<Message & { photo?: number }> = [
  {
    ...
    body: 'Look what’s going on here.',
    moment_id: 'moment-1',
    trade_id: 'trade-1',
  ...
  },
  {
    ...
    recipient_id: 'mia',
    body: 'Okay that’s unfair, it has rained here since this morning.',
    moment_id: null,
    trade_id: null,
  ...
  },
  {
    ...
    sender_id: 'mia',
    recipient_id: DEMO_USER_ID,
    body: 'Then show me the rain. Counts too.',
    moment_id: null,
    trade_id: null,
