...
import { fetchInbox } from '../data/momentsApi';
import { publishSnapshot } from '@/features/widget/data/widgetBridge';
import type { InboxMoment } from '../types';

type State = { data: InboxMoment[]; loading: boolean; error: Error | null };
