...
import type { InboxMoment } from '@/features/moments';
...
const SNAPSHOT_KEY = 'glimpse.widget.snapshot';

type GlimpseWidgetModule = {
...
export const widgetConfig = { APP_GROUP, SNAPSHOT_KEY, platform: Platform.OS } as const;
